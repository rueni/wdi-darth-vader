...
CREATE TABLE article (id SERIAL PRIMARY KEY, title varchar(255), description varchar(255), editor varchar(255), comments varchar(255) section_id integer), publish_date timestamp;
